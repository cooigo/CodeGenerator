...
namespace Cooigo.CodeGenerator
{
    public class GeneratorConfig
    {
        ...
        public string DataAccessProjectFile { get; set; }
        public string ModelProjectFile { get; set; }
        ...
        public GeneratorConfig()
        {
            ...
            KDiff3Path = @"D:\Program Files\KDiff3\kdiff3.exe";
        ...
        public static string GetConfigurationFilePath()
        {
            ...
            return Path.Combine(configPath, "CodeGenerator.config");
        }
